...
//creating a mock provider "fake firebase" for testing purposes.
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be able to initailized in 1 second',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('Login user should be a ble to get verified', () {
